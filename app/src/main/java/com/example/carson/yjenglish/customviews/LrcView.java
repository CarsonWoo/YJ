...
import com.example.carson.yjenglish.utils.LrcBean;
import com.example.carson.yjenglish.utils.LrcUtils;
...
public class LrcView extends View {
    ...
    public void setLrc(String lrc) {
        list = LrcUtils.parseStr2List(lrc);
    }
    ...
    public LrcView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        highLineColor = ta.getColor(R.styleable.LrcView_highLineColor, getResources().getColor(R.color.colorAccent));
