...
public class LoginTask implements NetTask<LoginModule> {
    ...
    //TODO 要将HOST替换
    private static final String HOST = "https://www.yiluzou.cn/yike/public/index.php/";
    ...
    public Subscription execute(LoginModule module, final LoadTasksCallback callback) {
        ...
        Subscription subscription = loginService.getLoginResponse(module.getUsername(), module.getPassword())
